...
const About = () => {
    return (
        <div data-scroll id='About' className='h-auto pb-20 w-full text-[#9ea2a3] font-normal text-sm leading-6 bg-[#121212] pt-14 border'>
            {/* #787C7D */}
            ...
            <div className='flex'>
                <div className='w-[100%] pl-20 text-start py-3'>
                    <p>
                ...
                <div className='w-2/4 items-center flex justify-end mr-20 relative'>
